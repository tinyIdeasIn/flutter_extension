...
import 'package:flutter_extension/src/int_extension.dart';
...
class ColorManager {
  ...
  static Color transparent({double alpha = 0}) => hex(0x000000, alpha: alpha);

  //随机颜色
  static Color get random => Color.fromRGBO(255.random, 255.random, 255.random, 1);

  static Color get theme => hex(_theme);
